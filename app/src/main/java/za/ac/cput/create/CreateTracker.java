...
public class CreateTracker {
    ...
    public CreateTracker(Context context, String baseUrl) {
        this.context = context;
        this.baseUrl = baseUrl;
    }

    public interface CreateTrackerListener {
        void onSuccess(); // Define additional parameters if needed

        void onError(VolleyError error);
    }

    public void GPSCreation(String tripId,int stops,int detours, CreateTrackerListener listener) {
        ...
        try {
            ...
            jsonObject.put("detours", detours);
